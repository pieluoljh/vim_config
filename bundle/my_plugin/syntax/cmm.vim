...
" keyword definitions
syn keyword traceConditional      if then else
syn keyword traceRepeat           repeat while

" trace commands
syn match   traceCommand        '\<\w\+\(\.\w\+\)*\>' transparent contains=traceFlashCommand,traceDataCommand,traceGlobalCommand,traceLocalCommand,traceWinpageCommand,traceAreaCommand,tracePrintCommand,traceEntryCommand,traceGosubCommand,traceReturnCommand,traceWaitCommand,traceChdirCommand,traceEnddoCommand,traceOsCommand,traceDoCommand,traceStringCommand,traceGotoCommand,traceSystemCommand,traceRegisterCommand
...
syn match   traceGosubCommand   '\<\(gosub\)\>' contained
hi link     traceGosubCommand   traceCommand
syn match   traceReturnCommand   '\<\(return\)\>' contained
hi link     traceReturnCommand   traceCommand
